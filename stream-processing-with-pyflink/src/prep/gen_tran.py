...
from tbl_src import Transaction, assign_operation

if __name__ == "__main__":
    """
    ## local execution
    python src/prep/gen_tran.py

    ## cluster execution
    docker exec jobmanager /opt/flink/bin/flink run \
        --python /tmp/src/prep/gen_tran.py \
    ...
    Transaction.generate(tbl_env, statement_set, BOOTSTRAP_SERVERS, print_only=False, row_per_sec=1)
