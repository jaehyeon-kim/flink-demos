...
class MinTempFunction(ReduceFunction):
    def reduce(self, value1: SensorReading, value2: SensorReading):
...
def define_workflow(source_stream: DataStream):
    return (
        ...
        .reduce(MinTempFunction())
        # .reduce(lambda a, b: a if a.temperature < b.temperature else b)
    )
