...
## how to specify different data structure than Row?
def define_workflow(source_stream: DataStream):
    return (
        ...
        .side_output_late_data(late_reading_output)
...
if __name__ == "__main__":
    """
    ## local execution
    python src/chapter6/late_events_redirect.py
    """
    ...
    env.execute("Redirect late readings to a side output in a window operator")
