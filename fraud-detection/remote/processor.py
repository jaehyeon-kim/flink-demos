...
def create_flagged_account_source_table(
    ...
    opts = {
        ...
        "properties.group.id": "flagged-accounts",
        "format": "json",
    ...
    """
    logging.info("flagged accounts table statement...")
    logging.info(stmt)
    return stmt
...
def create_transaction_source_table(
    ...
    """
    logging.info("transactions table statement...")
    logging.info(stmt)
    return stmt
...
def create_flagged_transaction_sink_table(table_name: str, topic_name: str, bootstrap_servers: str):
    ...
    """
    logging.info("flagged transactions table statement...")
    logging.info(stmt)
    return stmt
